...
import { Container, Header, ViewLogin } from "./styles";
    ...
    <Container style={{ backgroundColor: colors.background }}>
      <ScrollView style={{ marginBottom: normalize(90) }}>
        ...
        <Image
          ...
          source={require("../../../assets/nado.png")}
        />
        <View
          style={{
            flexDirection: "row",
        ...
        <Text style={{ padding: normalize(10), color: colors.text }}>
          Venda, Manutenção e Projetos de Piscinas. Com mais de 10 anos
          experiência e bons serviços prestados.
        </Text>
      </ScrollView>
      <ViewLogin
        onPress={() =>
